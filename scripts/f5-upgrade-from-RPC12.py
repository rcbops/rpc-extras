...
CLEANUP = (
    # Rename NOVA_CONSOLE TO NOVA_SPICE_CONSOLE
    # this is the cleanup
    r'delete ltm virtual /' + PART + '/' + PREFIX_NAME + '_VS_NOVA_CONSOLE',

    r'delete ltm virtual /' + PART + '/' + PREFIX_NAME +
    '_PUB_VS_NOVA_CONSOLE',
...
MONITORS = [
    ...
    '_MON_HTTP_NOVA_VNC_CONSOLE {'
    r' defaults-from http destination *:6082' +
    r' recv "200 OK" send "GET /vnc_auto.html'
    r' HTTP/1.1\r\nHost: rpc\r\n\r\n" }'
    '\n'
]
